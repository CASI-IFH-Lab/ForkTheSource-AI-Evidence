# STATUS — generated 2026-09-03 21:56 UTC, main @ da7cb1b
...
Module tags in these subjects: A1 · A2 · A3 · P5 · P6 · R1 · R2  _(heuristic — the interface table below is authoritative)_
...
| --- | --- | --- | --- | --- | --- |
| arsha | a1-judge | `arsha/a1-judge` | Arsha Jindal | 1h | 4 |
| arsha | a2-dashboard | `arsha/a2-dashboard` | Arsha Jindal | 1h | 2 |
| arsha | b1-contract | `arsha/b1-contract` | Arsha Jindal | 4h 15m | 0 |
| roy | — | `roy` | Ritik | 17h | 0 |
| roy-r1-corpus | — | `roy-r1-corpus` | Rithikroyt | 1h | 0 |
